...
export default function CollectionHeading(props) {
    ...
    const verifyAddress = (address) => {
        ...
        if (verified.name === '') {
            ...
            return (
                <>
                    <img src={verified.icon} className="rounded-border" />
                    <h1>
                        {verified.name}
                        <span
                            style={{
                        ...
                        >
                            Auctions: {auctionStats.auction_count}, Floor:{' '}
                            {numeral(auctionStats.price_floor / 1000000).format(
                                '0,0.00',
                            )}{' '}
                            UST
                        </span>
    ...
    useEffect(() => {
        ;(async () => {
            ...
            const obj_stats = (address) =>
                stats.data.infoCollections.find((a) => {
                    // console.log(a)
        ...
        <>
            {contractAddress && (
                <Head>
                    <meta charSet="UTF-8" />
                    <title>
                        {contract.mainnet[0][contractAddress]['name']} |{' '}
                        {contract.mainnet[0][contractAddress]['symbol']}
                    </title>
                    <meta
                        property="og:title"
                    ...
                    <meta
                        ...
                        content="Hey! Take a look at this NFT collection on Curio!"
                    />
                    <meta
                        property="og:image"
