...
export default () => {
    ...
    async function update_royalty() {
        try {
            ...
            if (recipient) exec_msg.update_royalty.recipient = recipient
            ...
            setUpdateInfo(
                'Error be sure to have enough LUNA to pay fees, Rayalty fee are only from 0 up to 10% max',
            )
            //   console.log(e)
        }
    }
                    ...
                    <div className="row">
                        <div className="col-md-8 intro mx-auto text-center">
                            ...
                            <p className="slogan fs-5">
                                NFTs can be programmed so that each transaction
                                includes royalties, allowing creators to be
                                rewarded fairly for their work online. You can
                                update your royalties on <strong>Curio</strong>{' '}
                                at any time.
                            </p>
                        </div>
                        <div className="col-md-8 mx-auto">
                            ...
                            <div className="col-12 mb-3">
                                ...
                                >
                                    Percentage amount, from 0 to max 10 % (if
                                    you need a custom amount email us at
                                    contact@curio.art)
                                </small>
                                <input
                                    type="number"
