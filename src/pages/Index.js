              ...
              <div className="col-md-4 mt-4">
                <div className="row">
                  ...
                  <div className="col-lg-9">
                    <p className="title">Curio Token</p>
                    <p className="info">When you want to attend a private auction you will need SITY tokens in order to unlock the private auction and participate</p>
                  </div>
                </div>              
              </div>
              ...
              <div className="col-md-4 mt-4">
                <div className="row">
                  ...
                  <div className="col-lg-9">
                    ...
                    <p className="info">Everyone will be able to sell their nfts on the Curio marketplace, setup your desired start time or even select a fee for your favorite charity</p>
                  </div>
                </div>              
              </div>
