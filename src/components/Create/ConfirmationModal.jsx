...
export default function ConfirmationModal(props) {
    ...
    return (
        <div
            className={'confirm-background d-flex' + (!confirm ? '' : ' show')}
        >
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <button
                                    ...
                                    onClick={() => finalCreation()}
                                >
                                    Confirmed, create auction
                                </button>
                            </div>
                        </div>
                    </div>
