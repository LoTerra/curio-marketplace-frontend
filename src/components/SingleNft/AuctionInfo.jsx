...
export default function AuctionInfo(props) {
    ...
    const {nftData, bidInfo, imageNftData, nftValid, bidder, buyNow, rightsCheck, isOwner} = props;
        ...
        <>
                                <div className="col-12">
                                    <div className="nft-stats big w-100 my-2">
                                        <h6>Highest bid</h6>
                                        <p className="highest_bid mb-0">{numeral(nftData.highest_bid / 1000000).format("0,0.000000")} <span>UST</span></p>
                                ...
                                <div className="col-6">
                                    <div className="nft-stats">
                                        <h6>Reserve price</h6>
                                        <p className="highest_bid">{nftData.reserve_price ? numeral(nftData.reserve_price / 1000000).format("0,0.000000") : 'No'} {nftData.reserve_price && <span>UST</span>}</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-6">
                                    <div className="nft-stats">
                                        <h6>Opening bid</h6>
                                        <p className="start-price">{nftData.start_price ? numeral(nftData.start_price / 1000000).format("0,0.000000") : 'No' } {nftData.start_price && <span>UST</span>}</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-6">
                                    <div className="nft-stats">
                                        <h6>Buyout</h6>
                                        <p className="start-price">{nftData.instant_buy ? numeral(nftData.instant_buy / 1000000).format("0,0.000000") : 'No'} {nftData.instant_buy && <span>UST</span>}</p>
                                    </div>
                                </div>
                                ...
                                >{nftData && nftValid(nftData.end_time,nftData.start_time) ? 'Place bid' : nftData.start_time * 1000 > Date.now() ? 'Auction not started yet' : 'Auction finished'}                                
                                    ...
                                    {nftData && nftValid(nftData.end_time,nftData.start_time) && nftData.instant_buy && rightsCheck() && !isOwner &&
